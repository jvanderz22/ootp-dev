...
class ShortstopAttributeModel(AttributeModel):
    ...
    def test_data(self):
        return [
            ...
            [52, [65, 65, 65, 65]],  # solid regular
            [54, [65, 65, 70, 65]],  # solid regular
            ...
            [64, [65, 80, 80, 80]],  # higher range bounds
            [73, [70, 80, 80, 80]],  # higher range bounds
            [48, [65, 60, 65, 60]],  # lower bounds baseline
