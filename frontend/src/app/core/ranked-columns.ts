...
const BATTING_COLUMNS: ColumnDef[] = [
  ...
  gradeCol('fielding.ofError', 'OFE', 'OF Error', 'Outfield', field('ofError')),
  ...
  gradeCol('fielding.cArm', 'CAR', 'C Arm', 'Catching', field('cArm')),
  ...PERSONALITY_COLUMNS,
  DEMAND_COLUMN,
];
